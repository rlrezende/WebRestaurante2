...
(function () {
    ...
    var config = function ($routeProvider, $locationProvider) {
        ...
        .when("/Restaurantes",
               { templateUrl: "/cliente/html/restaurantes/Resturantes.html", controller: "restaurantesController" })
        .when("/Restaurantes/Cadastro",
               { templateUrl: "/cliente/html/restaurantes/Cadastro.html", controller: "restaurantesController" })
        .when("/Restaurantes/Alterar",
               { templateUrl: "/cliente/html/restaurantes/Alterar.html", controller: "restaurantesController" })
        .when("/Pratos/Cadastro",
               { templateUrl: "/cliente/html/Pratos/Cadastro.html", controller: "PratosController" })
        .when("/Pratos/Alterar",
               { templateUrl: "/cliente/html/Pratos/Alterar.html", controller: "PratosController" })
        .when("/Pratos",
               { templateUrl: "/cliente/html/pratos/Pratos.html", controller: "PratosController" })
        .otherwise(
               { redirecTo: "/" });
